...
{  
    ...
    public class SystemParameter : ViewModelBase
    {
        ...
        public RobotPoint FixtureBarcodePoint
        {
            ...
            set { fixtureBarcodePoint = value; }
                //this.OnPropertyChanged("FixtureBarcodePoint"); }
        }
        ...
        public RobotPoint ScannerLeftPos
        {
            ...
            set { scannerLeftPos = value; }
                //this.OnPropertyChanged("ScannerLeftPos"); }
        }
        ...
        public RobotJointAngle ScannerLeftJointAngle
        {
            ...
            set { scannerLeftJointAngle = value; }
        ...
        public RobotJointAngle ScannerRightJointAngle
        {
            ...
            set { scannerRightJointAngle = value; }
                //this.OnPropertyChanged("ScannerRightJointAngle"); }
        }
        ...
        public double Arm2OrgLength
        {
            ...
            set { arm2OrgLength = value; }
                // this.OnPropertyChanged("Arm2OrgLength"); }
        }
        double arm2Length;
        public double Arm2Length
        {
            get { return arm2Length; }
            set { arm2Length = value; } 
                //this.OnPropertyChanged("Arm2Length"); }
        }
        double arm2Angle;
        public double Arm2Angle
        {
            ...
            set { arm2Angle = value;}
                //this.OnPropertyChanged("Arm2Angle"); }
        }
    ...
    public class Serializer
    {
        ...
        private static string strFolder = MachineGUIDirectroy+ @"/System/";
