...
public class CheckSpot2Offset : INotifyPropertyChanged
{
    public CheckSpot2Offset() { }
    public CheckSpot2Offset ShallowCopy()
    {
        return (CheckSpot2Offset)this.MemberwiseClone();
