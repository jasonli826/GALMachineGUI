...
public class FlyCheckSpot3Offset : INotifyPropertyChanged
{
    public FlyCheckSpot3Offset() { }
    public FlyCheckSpot3Offset ShallowCopy()
    {
        return (FlyCheckSpot3Offset)this.MemberwiseClone();
