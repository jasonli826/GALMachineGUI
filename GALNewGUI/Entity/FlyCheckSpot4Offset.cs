...
public class FlyCheckSpot4Offset : INotifyPropertyChanged
{
    public FlyCheckSpot4Offset() { }
    public FlyCheckSpot4Offset ShallowCopy()
    {
        return (FlyCheckSpot4Offset)this.MemberwiseClone();
